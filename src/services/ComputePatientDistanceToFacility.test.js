const ComputePatientDistanceToFacility = require('./ComputePatientDistanceToFacility');
...
describe('ComputePatientDistanceToFacility', () => {
	beforeEach(() => {
		patientsWithDistance = computePatientDistanceToFacility.execute(FACILITY_LOCATION, TEST_DATA);
	});

	it('should calculate the distance between facility location and a patient', () => {
